...
# Usage:  sudo ./install.sh            # installs to /home/andy/internet_state_rgb
#         sudo INSTALL_DIR=/opt/irgb ./install.sh   # custom location
set -euo pipefail

INSTALL_DIR="${INSTALL_DIR:-/home/andy/internet_state_rgb}"
...
sed "s#/home/andy/internet_state_rgb#${INSTALL_DIR}#g" \
